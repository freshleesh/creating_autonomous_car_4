...
class PPNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info(
            f'PPNode v4 ready | v_scale={self.v_scale:.2f}  a_lat_max={self.a_lat_max:.1f}'
    ...
    def _compute(self):
        ...
        #   경로 이탈할수록 속도 감쇠: 고속+이탈 조합이 spin의 근본 원인
        #   CTE=0 → 감쇠 없음, CTE=0.5m → 속도 80%, CTE=1.0m → 속도 55%
